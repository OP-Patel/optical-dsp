...
Milestones 09 and 10 fixed-point DC removal and FIR filtering are implemented;
bit-exact simulations and routed tap-variant builds pass, and their combined
physical before/after captures remain.
